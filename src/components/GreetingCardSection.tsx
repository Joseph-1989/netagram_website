...
export default function BusinessCardSection() {
  ...
  const getImageSrc = (type: 'profile' | 'business') => {
    if (type === 'profile') {
      return language === 'ko'
        ? '/images/NetagramFeatureIntro/use_netagram_body_image_5_ko.png'
        : '/images/NetagramFeatureIntro/use_netagram_body_image_5_en.png';
    } else {
      return language === 'ko'
        ? '/images/NetagramFeatureIntro/use_netagram_body_image_5_ko.png'
        : '/images/NetagramFeatureIntro/use_netagram_body_image_5_en.png';
  ...
  const getMobileImageSrc = (type: 'profile' | 'business') => {
    if (type === 'profile') {
      return language === 'ko'
        ? '/images/NetagramFeatureIntro/use_netagram_body_image_5_mobile_ko.png'
        : '/images/NetagramFeatureIntro/use_netagram_body_image_5_mobile_en.png';
    } else {
      return language === 'ko'
        ? '/images/NetagramFeatureIntro/use_netagram_body_image_5_mobile_ko.png'
        : '/images/NetagramFeatureIntro/use_netagram_body_image_5_mobile_en.png';
