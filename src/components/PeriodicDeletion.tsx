...
export default function PeriodicDeletion() {
  ...
  const getImageSrc = () => {
    return language === 'ko'
      ? '/images/NetagramFeatureIntro/use_netagram_body_image_2_ko.png'
      : '/images/NetagramFeatureIntro/use_netagram_body_image_2_en.png';
  };

  const getMobileImageSrc = () => {
    return language === 'ko'
      ? '/images/NetagramFeatureIntro/use_netagram_body_image_2_mobile_ko.png'
      : '/images/NetagramFeatureIntro/use_netagram_body_image_2_mobile_en.png';
  };
