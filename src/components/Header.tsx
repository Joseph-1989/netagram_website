...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#C3FFD9]">
      <div className="container mx-auto px-4 w-[1440px]">
        <div className="flex items-center justify-start h-16 gap-4">
          ...
          <div className="flex w-[100%] items-center justify-between space-x-4">
            ...
            <nav className="flex flex-col space-y-4">
              {navItems.map(item => (
                <Link
                  ...
                  href={item.href}
                  className={`nav-link transition-colors hover:text-[#00D9B8] ${
                    pathname === item.href ? 'text-[#00D9B8]' : 'text-[#000]'
                  }`}
      ...
      {/* Submenu - only visible when hovering NETAGRAM Is or COMMUNITY */}
      {(hoveredMenu === 'NETAGRAM Is' || hoveredMenu === 'COMMUNITY') && (
        <div className="bg-[#C3FFD9] w-full h-16">
          <div className="container mx-auto px-4 w-[1440px]">
            <div className="flex items-center justify-start h-16 gap-8">
              {hoveredMenu === 'NETAGRAM Is' && (
                <>
                  <Link
                    href="/netagram-introduction"
                    className={`submenu-link hover:text-[#00D9B8] transition-colors ${
                      pathname.startsWith('/netagram-introduction')
                        ? 'font-bold text-[#00D9B8]'
                        : ''
                    }`}
                  >
                    NETAGRAM 소개
                  ...
                  <Link
                    href="/netagram-feature-intro"
                    className={`submenu-link hover:text-[#00D9B8] transition-colors ${
                      pathname.startsWith('/netagram-feature-intro')
                        ? 'font-bold text-[#00D9B8]'
                        : ''
                    }`}
                  >
